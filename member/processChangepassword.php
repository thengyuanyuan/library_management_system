...
<html>
	<body>
		...
		$query = "SELECT password FROM member WHERE id='$login_id'";
        ...
        if($oldpass1!=$oldpass2){
            ...
            // build the query to update data into member table
            $query = "UPDATE member SET password = '$newpass' WHERE id='$login_id'";
